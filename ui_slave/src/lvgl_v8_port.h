 ...
 *  Must be large enough for the deepest LVGL call chain including
 *  practice mode poll timer → practice_apply_engine_move → practice_render_board.
 */
#define LVGL_PORT_TASK_STACK_SIZE (24 * 1024)
